...
def print_hot_or_cold(target, guess): 
    ...
    if dist == 0: #same number
        ...
        print("warm")
    #otherwise, do nothing... if dist > 5, then nothing happens
    # until I add the following lines
    elif dist <=8: 
        print("cold")
    elif dist <=13: 
        print("very cold")
...
if __name__ == "__main__": #or != "__main__" don't run if run in command line
...
##Might be helpful to have a demo.
##!!!!!look up how to explain __name__